...
from extract_maps import rom, assert_rom, load_rom, calculate_pointer, \
                         load_map_pointers, read_all_map_headers, map_headers
...
def load_asm(filename="../main.asm"):
    """
        Loads the ASM source code into memory. This also detects if the
        revision of the repository is using main.asm, common.asm or
        pokered.asm, which is useful when generating images in
        romvisualizer.py.
    """
